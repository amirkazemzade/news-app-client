class NewsDetailsResponseModel {
  ...
  NewsDetailsResponseModel.fromJson(dynamic json) {
    _state = json['state'];
    _message = json['message'];
    _result = json['result'] != null
        ? NewsDetailsModel.fromJson(json['result'])
        : null;
  }

  String? _state;
  dynamic _message;
  NewsDetailsModel? _result;

  String? get state => _state;

  dynamic get message => _message;

  NewsDetailsModel? get result => _result;
